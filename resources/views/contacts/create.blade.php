...
<div class="main">
    ...
    <div class="container">
       <form action="{{ route('contacts.store') }}" method="POST" id="contactForm" class="styled-form">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="tel" id="phone" name="phone" pattern="[0-9]{11}" value="{{ old('phone') }}" required>
