...
<div class="navbar">
    <div class="top-icons">
        <a href="{{ route('contacts.create') }}" class="icon-btn"><i class="fa-solid fa-plus"></i></a>
        <a href="{{ route('contacts.index') }}" class="icon-btn"><i class="fa-solid fa-users"></i></a>
    </div>
</div>

<div class="main">
    <div class="container">
       <form action="{{ route('contacts.update', $contact->id) }}" method="POST" id="editForm" class="styled-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="tel" id="phone" name="phone" pattern="[0-9]{11}" value="{{ old('phone', $contact->phone) }}" required>
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('contacts.index') }}" class="cancel-btn">
