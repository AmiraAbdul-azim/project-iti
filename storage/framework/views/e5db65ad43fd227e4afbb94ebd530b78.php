...
<div class="navbar">
    <div class="top-icons">
        <!-- أيقونة إضافة -->
        <a href="<?php echo e(route('contacts.create')); ?>" class="icon-btn">
            <i class="fa-solid fa-plus"></i>
        </a>
        <!-- أيقونة الأشخاص -->
        <a href="<?php echo e(route('contacts.index')); ?>" class="icon-btn">
                    ...
                    <tr>
                        <td>
                            <div class="name-cell">
                                ...
                                <span><?php echo e($contact->name); ?></span>
                            </div>
                        </td>
                        <td><?php echo e($contact->phone); ?></td>
                        <td><?php echo e($contact->email); ?></td>
                        <td><?php echo e($contact->updated_at->format('Y-m-d H:i')); ?></td>
                        <td>
                            <div class="action-buttons">
                                <a href="<?php echo e(route('contacts.edit', $contact->id)); ?>" class="edit">Edit</a>
                                <form action="<?php echo e(route('contacts.destroy', $contact->id)); ?>" method="POST" class="delete-form">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LOQ\myapp\resources\views/contacts/index.blade.php ENDPATH**/ ?>